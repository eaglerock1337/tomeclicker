<script lang="ts">
	...
	function importSave() {
		...
		if (result.success) {
			...
			importText = '';
			gameStore.set(game); // Update store to force reactivity
...
<div class="saves">
	...
	<div class="saves-layout">
		<div class="save-section">
			...
			<p>Your game automatically saves to browser storage every 15 seconds.</p>
		...
		<div class="save-section">
			...
			<p class="note">Save files are stored in JSON format for easy backup and transfer.</p>
		</div>

		<div class="save-section">
			<h2>Import Save File</h2>
			<p>Paste save data below to import from a file or another device.</p>
			<textarea bind:value={importText} placeholder="Paste your save data here..." rows="8"
			></textarea>
