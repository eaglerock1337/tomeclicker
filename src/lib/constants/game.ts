 ...
 */
export const BASE_LEVEL_COST = 1000;

/**
 * Exponential multiplier for level up costs
 * Results in: 1k, 1M, 1B, 1T... (1000x per level)
 */
...
// ============================================================================
// UPGRADE ECONOMICS & LEVEL CAPS
// ============================================================================
// NOTE: All upgrade costs, multipliers, and max levels are now defined in
// src/lib/config/upgrades.yaml for easier game balance tuning
